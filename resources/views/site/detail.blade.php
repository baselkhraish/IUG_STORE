    ...
    <div class="container-fluid py-5">
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('uploads/images/products/' . $product_s->photo) }}"
                                alt="Image">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">{{ $product_s->name }}</h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">
                    @if ($product_s->falg == 0)
                        {{ $product_s->base_price }}$
                    @else
                        {{ $product_s->discount_price }}$
                        <br><span class="text-danger" style="font-size: 13px">after discount</span>
                    @endif
                </h3>
                <p class="mb-4">{!! $product_s->description !!}</p>

                <div class="d-flex align-items-center mb-4 pt-2">


                    <form action="{{ route('site.transactions', $product_s->id) }}" method="POST">
                        @csrf

                        <input type="hidden" name="product_id" value="{{ $product_s->id  }}">
                        <input type="hidden" name="product_name" value="{{ $product_s->name  }}">
                        <input type="hidden" name="store_name" value="{{ $product_s->store->name  }}">
