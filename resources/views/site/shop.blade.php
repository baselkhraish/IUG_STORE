                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div
                                    ...
                                    <img class="img-fluid"  style="width: 325px; height: 217px; object-fit: cover;" src="{{ asset('uploads/images/products/' . $item->photo) }}"
                                        alt="">
                                </div>
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    ...
                                    <form action="{{ route('site.transactions', $item->id) }}" method="POST">
                                        ...
                                        <input type="hidden" name="sale"
                                            value="
                                                    @if ($item->falg == 0) {{ $item->base_price }}$
                                                    @else
                                                        {{ $item->discount_price }}$ @endif">
